...
renderPlot({
  ...
  ggplot() +
  geom_line(aes(x=position, y=goal_diff), size = 1.5, color = "red", linetype = "solid") +
  geom_line(aes(x=position, y=no_pen_exp_goal_diff), size = 1.5, color = "darkgreen", linetype = "solid") +
...
renderPlot({
  ...
  data_per_club |> filter(year == input$year_season, 
                   ...
                   ggplot() + 
                   geom_point(aes(scored/38, deep/38)) +
                   geom_smooth(aes(scored/38, deep/38)) + 
