...
<!-- centering the title of the dashboard that will be displayed on each page -->
...
<!-- In this chunck there is all the code that is required to develop our dashboard and that is not going to be shown on the output -->
...
<!-- There are three main pages on our dashboard, here the first is defined. The line below define the orientation on how to add new plots and the icon that will represent this page. -->

Team {data-icon="fa-futbol" data-orientation=rows}
==========================

<!-- this option allows to create a sidebar on the left of the page where the user can chooose and store his input. The option .sidebar create more pages with tabs -->
...
<!-- with the option .tabset-fade is possible to change the effect on changing a tab -->
...
<!-- the second page of the dashboard is create  -->
...
<!-- creating the last page of the dashboard -->
